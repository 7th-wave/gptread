...
function importSVGsAndCreateSymbolLibrary() {
    ...
    var saveFolder = Folder.selectDialog("Select the folder to save the symbol libraries:");
    if (saveFolder === null) return;

    var baseName = prompt("Enter the base name for the auto-saved symbol libraries:", "SymbolLibrary");
    ...
    for (var i = 0; i < svgFiles.length; i++) {
        ...
        if (symbolsAdded % 3 === 0) {
            var saveFile = new File(saveFolder + "/" + baseName + "_" + (symbolsAdded / 3) + ".ai");
